...
DialogUI::DialogUI(class World* world) : UIPanel(world)
{
  ...
  std::string gunfire = "\\Library\\CSV\\Eliza_Animation\\Eliza_Initiative_Gunfire.csv";
  std::string noble = "\\Library\\CSV\\Eliza_Animation\\Eliza_Noble.csv";
  std::string d30 = "\\Library\\CSV\\Eliza_Animation\\Eliza_Resistance_Despair30.csv";
  std::string d70 = "\\Library\\CSV\\Eliza_Animation\\Eliza_Resistance_Despair70.csv";
  std::string joy = "\\Library\\CSV\\Eliza_Animation\\Eliza_Resistance_Joy.csv";
  std::string sad = "\\Library\\CSV\\Eliza_Animation\\Eliza_Resistance_Sad.csv";
...
{
  UIPanel::Update(dt);
  if (INPUT.IsKeyPress(Key::D1)) _Eliza->SetCurrentAnimSprite("Eliza_Initiative_Gunfire");
  if (INPUT.IsKeyPress(Key::D2)) _Eliza->SetCurrentAnimSprite("Eliza_Resistance_Despair30");
  if (INPUT.IsKeyPress(Key::D3)) _Eliza->SetCurrentAnimSprite("Eliza_Resistance_Despair70");
  if (INPUT.IsKeyPress(Key::D4)) _Eliza->SetCurrentAnimSprite("Eliza_Noble");
  if (INPUT.IsKeyPress(Key::D5)) _Eliza->SetCurrentAnimSprite("Eliza_Resistance_Sad");
  if (INPUT.IsKeyPress(Key::D6)) _Eliza->SetCurrentAnimSprite("Eliza_Resistance_Joy");
}
